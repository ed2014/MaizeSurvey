...
Figure 8. Most commonly experienced, early- and late-sowing dates reported by respondents per region. Boxes show quantile distributions or ranges.
...
The most common factor that delays sowing date were excessive soil moisture in spring, with the exception of Canterbury where low temperatures (including risks of frost) was the main delay factor (Figure 9).
...
Figure 9. Main factors contributing to a delay in the time of maize sowing. Number of producers that selected each category. Low temperatures category include frost risk and cold spring weather conditions. The category "others" include lack of available machinery and dry soil conditions.
